...
import {HeaderHomeComponent} from './pages/home/sub-header/header-home.component';
...
import {FooterHomeComponent} from './pages/home/footer/footer-home.component';
...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, FormsModule, NgIf, HeaderHomeComponent, Section1HomeComponent, Section2HomeComponent, Section3HomeComponent, Section4HomeComponent, Section5HomeComponent, Section6HomeComponent, Section7HomeComponent, FooterHomeComponent, NotFoundComponent, NavbarComponent],
